---
title: "Session 5 - Regression discontinuity"
format: html
toc: true
editor: visual
---
...
This session will present regression discontinuity. The next one will be devoted to instrumental variables.
...
\end{equation} where $X_i$ is the running variable, and $D_i$ is the treatment dummy.
