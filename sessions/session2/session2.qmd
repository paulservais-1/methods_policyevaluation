...
1. Remind you important notions of statistical inference, which we will be using for the rest of the class;
2. Introduce you to t-tests;
3. Introduce you to linear regression models;
